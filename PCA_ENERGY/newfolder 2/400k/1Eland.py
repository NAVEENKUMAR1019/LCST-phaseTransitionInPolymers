...
data = pd.read_csv("pce400k.csv",header=None)
...
plt.title("400k",fontweight="bold")
surf = ax.contourf(Xi,Yi,Zi,cmap=cm.seismic)

fig.colorbar(surf,shrink=1.0)

plt.savefig('contour400k.png')
plt.show()
